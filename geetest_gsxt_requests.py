...
class gsxt(object):
    ...
    def process_1(self):
        ...
        # prox = requests.get("http://proxy.abuyun.com/switch-ip", proxies=self.proxies)
...
class crack_picture(object):
    ...
    def darbra_track(self, distance):
        ...
        # tracks = [[-28,-20,0],[0,0,0],[2,0,281],[7,0,296],[14,0,313],[24,-1,330],[40,-3,348],[58,-4,365],[71,-5,383],[98,-7,400],[114,-9,416],[125,-10,434],[135,-10,451],[140,-10,468],[142,-10,486],[144,-10,506],[145,-10,522],[145,-10,592]]
        # print('array length is {}'.format(n_item))
        # print('xpos is {}'.format(distance))
        # print('passtime is {}'.format(tracks[-1][-1]))
